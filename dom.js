...
//---> .TextContent (show all the content with out html tags)
...
// nodelist and HtmlCollection are not pure arrays we can't use all the methods that are used in arrays.
